...
{
	public class RptCounter_Dtl
	{
		public const string tbname = "RptCounter_Dtl";
		...
		public List<RptCounter_Dtl> get()
		{
			var rows = new List<RptCounter_Dtl>();
