...
{
	public class Customs_Response
	{
		public const string tbname = "Customs_Response";
		...
		public List<Customs_Response> get()
		{
			var rows = new List<Customs_Response>();
				...
				using (var rd = cn.getDataReader("select * from " + tbname))
				{
					while (rd.Read())
					{
						rows.Add(new Customs_Response()
						{
							...
							UploadStatus = rd.GetString("UploadStatus"),
